...
```js copy
 {{baseUrl}}/api/v1/business-api-services-wallets/:id
```
...
```sh copy
curl --location -g '{{baseUrl}}/api/v1/business-api-services-wallets/c7ddb254-5da1-4136-b19e-733a00a31c70' \
